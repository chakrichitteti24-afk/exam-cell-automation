"""
Bulk import 109 Real 2nd Year CSE students into GKCE Exam Cell Database.
Semester: 3 (2nd Year, Academic Year 2026-2027)
...
def import_2nd_year():
    input_file = os.path.join(os.path.dirname(__file__), "2nd_year_students.json")
    with open(input_file, "r", encoding="utf-8") as f:
        records = json.load(f)

    print("=" * 65)
    print(f"Bulk Importing {len(records)} Real 2nd Year CSE Students into GKCE Database")
    print("=" * 65)
    ...
    try:
        ...
        print("=" * 65)
        print("[SUCCESS] 2nd Year CSE Batch Imported Successfully!")
