"""
Bulk import 109 Real 1st Year MBA students into GKCE Exam Cell Database.
Semester: 1 (1st Year MBA, Academic Year 2026-2027)
Department: MBA (Department ID 6)
...
def import_1st_year_mba():
    input_file = os.path.join(os.path.dirname(__file__), "1st_year_mba_students.json")
    with open(input_file, "r", encoding="utf-8") as f:
        records = json.load(f)

    print("=" * 65)
    print(f"Bulk Importing {len(records)} Real 1st Year MBA Students into GKCE Database")
    print("=" * 65)
